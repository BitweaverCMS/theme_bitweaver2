...
<div id="dcd">
	<ul class="doc">
		<li><a href="/wiki/Bitweaver+Overview"><strong>features </strong>of bitweaver</a></li>
	...
	<ul class="com">
		<li><a href="/wiki/bitweaver_sites">bitweaver live sites</a></li>
		<li><a href="/blogs/">user blogs</a></li>
	...
	<ul class="dev" style="margin-right:0px">
		<li><a href="/articles/index.php?topic_id=5">announcements</a></li>
		<li><a href="/articles/index.php?topic_id=3">security notices</a></li>
